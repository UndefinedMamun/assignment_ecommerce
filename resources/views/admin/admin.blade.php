...
<html lang="en">
    <head>
        ...
        <!-- start: Meta -->
        <meta charset="utf-8">
        <title>Dashboard of <?php echo Session::get('admin_name');?></title>
        ...
        <!--[if lt IE 9]>
                ...
                <link id="ie-style" href="{{asset('public/admin/css/ie.css')}}" rel="stylesheet">
        <![endif]-->

        <!--[if IE 9]>
                <link id="ie9style" href="{{asset('public/admin/css/ie9.css')}}" rel="stylesheet">
        <![endif]-->
        ...
        <style type="text/css">
            body { background: url({{asset('public/admin/img/bg-login.jpg')}}) !important; }
        </style>
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="{{url('/add-category')}}"><i class="icon-envelope"></i><span class="hidden-tablet">Add Category</span></a></li>
                            
                            <li><a href="{{url('/manage-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Category</span></a></li>
                            <li><a href="{{url('/add-manufacturer')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Manufacturer</span></a></li>
                            <li><a href="{{url('/manage-manufacturer')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Manage Manufacturer</span></a></li>
                            <li><a href="{{url('/add-product')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Product</span></a></li>
                            <li><a href="{{url('/manage-product')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Manage Product</span></a></li>
                            <li>
