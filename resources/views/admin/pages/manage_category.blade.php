                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <?php }?>
                            <a class="btn btn-info" href="{{url('/edit-category/'.$v_category->category_id)}}">
                                <i class="halflings-icon white edit"></i>  
                            </a>
                            <a class="btn btn-danger" href="{{url('/delete-category/'.$v_category->category_id)}}" onclick="return confirm('Are you sure want to delete this!!');">
