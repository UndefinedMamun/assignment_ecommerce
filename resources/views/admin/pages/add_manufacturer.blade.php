...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            ?></h2>
            {!! Form::open(['url'=>'/save-manufacturer', 'method'=>'POST', 'class'=>'form-horizontal', 'enctype'=>'multipart/form-data']) !!}
                <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Manufacturer Name </label>
                        <div class="controls">
                            <input type="text" class="span6 typeahead" name="manufacturer_name" id="typeahead"  />
